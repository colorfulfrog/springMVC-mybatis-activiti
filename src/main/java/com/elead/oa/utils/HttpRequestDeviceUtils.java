 ...
 * @date 创建时间：2017年2月28日 下午12:02:53
 * @version 1.0
 * @company Elead
 */
public class HttpRequestDeviceUtils
{
	 ...
	 * @throws IOException
	 */
	public static boolean isMobileDevice(HttpServletRequest request) throws IOException {
		...
		try {
			...
			if (isFromMobile) {
				...
				String platform = request.getParameter("platform");	// 区分移动端平台的参数 Android 判断不了上面的方法
